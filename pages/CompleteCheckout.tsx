  ...
  return (
    <section className="complete-checkout mx-auto pt-lg-145 pb-lg-145 pt-100 pb-80">
      <div className="container-fluid">
        ...
        <Image src='/icon/complete-checkout.svg' width={343} height={300} />
        </div>
        ...
        <div className="button-group d-flex flex-column mx-auto">
          <a className="btn btn-dashboard fw-medium text-lg text-white rounded-pill mb-16" href="/" role="button">
            My Dashboard
          </a>
